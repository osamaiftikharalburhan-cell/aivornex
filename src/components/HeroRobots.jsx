...
export default function HeroRobots() {
  return (
    <>
      ...
      <div className="pointer-events-none absolute left-0 top-0 scale-[0.4] sm:left-[1%] sm:top-[4%] sm:scale-75 md:left-[2%] md:top-[20%] md:scale-100 lg:left-[6%]">
        <motion.div
      ...
      <div className="pointer-events-none absolute right-0 top-0 scale-[0.4] sm:right-[1%] sm:top-[4%] sm:scale-75 md:right-[2%] md:top-[16%] md:scale-100 lg:right-[6%]">
        <motion.div
          animate={{ y: [14, -14, 14], rotate: [4, -4, 4] }}
